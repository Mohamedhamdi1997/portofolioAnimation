...
import { muhib, hero } from '../../assets/images'
           ...
           <div className='md:flex items-center justify-between sm:flex-col md:flex-row'>
            <div className='w-full md:basis-1/2'>
                ...
                <h1
                 ...
                 >
                    I'm Mohamed Hamdi<br />Software Developer</h1>
                   <div
                   data-aos="fade-up"
                   ...
                   >
                    ...
                    >
                        ...
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi ullam enim inventore eius maxime magnam voluptate veritatis culpa quia ipsam.
                        </p>
            ...
            md:flex-col md:justify-end md:text-end'>
              <div className='mb-10'>
                <h2 className='text-headlingColor font-[700] text-[32px]'>
                  <CountUp start={0} end={6} duration={2} suffix='+' />
                </h2>
                <h4 className='text-headlingColor font-[600] text-[18px]'>
                  Years of Experience
                </h4>
              </div>
              <div className='mb-10'>
