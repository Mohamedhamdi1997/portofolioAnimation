    ...
    <section id='services'>
        <div className='container lg:pt-5'>
          ...
          <p className='lg:max-w-[600px] lg:mx-auto text-headingColor font-[500] text-[16px] leading-7'>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Soluta earum unde blanditiis reiciendis tempore nisi debitis perspiciatis ullam deleniti cum, sunt atque neque beatae rerum odit. Dolor soluta asperiores ipsam?
            </p>  
            </div> 
                      ...
                      <div className='flex justify-start w-full mx-auto items-center'>
                        <div className='w-full sm:w-1/2 sm:pr-8'>
                          ...
                          className='bg-white p-4 rounded shadow group hover:bg-primaryColor cursor-pointer ease-in duration-150'>
                           ...
                           Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorem voluptatibus accusamus vitae laboriosam fuga eius.
                            </p>
                          </div>
                        </div>
                      </div>
