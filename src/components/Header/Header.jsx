        ...
        <div className='flex items-center justify-between'>
            <div className='flex items-center gap-[10px]'>
                ...
                <div className="leading-[20px]">
                    <h2 className='text-xl text-smallTextColor font-[700]'>Mohamed</h2>
                    <p className='text-smallTextColor text-[16px] font-[500]'>personel</p>
                </div>
            </div>
            <div className='Menu'>
                <ul className='flex items-center gap-10'> 
                    ...
                    <li><a className='text-smallTextColor font-[600]'href='#portofolio'>Portofolio</a></li>
